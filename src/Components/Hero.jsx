    ...
    <section className="py-32 bg-black" id="hero">
      <div className="container flex flex-col gap-20 justify-center items-center">
        <div className="flex justify-center items-center flex-col gap-6">
          ...
          <div className="text-white text-5xl font-normal font-Jack">
            CURRENT MKCAP{" "}
          </div>
        </div>
        ...
        <div className="grid w-full grid-cols-1 lg:grid-cols-2 justify-between gap-16 items-center">
          <article className="flex flex-col gap-4">
            <h1 className="text-white text-5xl font-normal font-JackCon leading-10">
              Welcome To CURRENT MKCAP
            </h1>

            <div className=" text-white text-base font-normal font-['Jost'] leading-loose tracking-tight">
              Our token name is as changeable. We're calling it the 'CURRENT
              NAME = MKCAP' initiative. What's the catch? Every time the market
              cap (mkcap) shifts, whoosh – our project's name changes too!
              <br />
              <br />
            </div>
            <a
              href=""
              className="w-64 h-14 px-8 py-4 origin-top-left -rotate-3 bg-white rounded border-2 border-green-600 justify-center items-center gap-2.5 inline-flex"
            >
              <div className="text-black text-xl font-normal font-Jack leading-7 tracking-tight">
                BUY NOW
              </div>
            </a>
